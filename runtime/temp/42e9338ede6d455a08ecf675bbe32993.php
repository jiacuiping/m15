<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/newm15/public/../application/index/view/collection/music.html";i:1573729491;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="layui-card-body" style="padding:10px 15px 0 15px;">
            <div class="mtd-shipin-tab-left">
              <ul class="clear">
                ...
                <li><a href="javascript:;" class="checked-bottom">音乐收藏</a></li>
...
<!--                 <li><a href="<?php echo url('goods'); ?>">商品收藏</a></li>
      ...
      <div class="layui-col-md12" style="padding-top: 0">
        <div class="layui-form">
          <?php if(empty($data)): ?>
            <div style="text-align: center;margin-top: 100px;">暂无音乐数据</div>
          <?php else: ?>
                ...
                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                  <tr>
                    ...
                    <td class="mtd-shipin-td-btn">
                      ...
                      <button type="button" class="layui-btn-sm operationbat removeCollect" data-value="<?php echo $item['music_id']; ?>"><img src="/static/index/layuiadmin/imgs/caozuo3.png" alt="">收藏</button>
                    </td>
                  </tr>
...
layui.use('carousel', function(){
  ...
  layui.config({
    ...
    $(".goinfo").click(function(){
      location.href="<?php echo url('music/info','',false); ?>/mid/" + $(this).attr('data-value');
    });


    $(".removeCollect").click(function(){
      var key = $(this).attr('data-value');
      layer.confirm('确定取消收藏该音乐吗？', {
        btn: ['确定','取消'] //按钮
      }, function(){
          $.ajax({
