...
class Specification extends Model
{
    ...
    //声明添加时间字段
    protected $createTime = 'spec_time';
    //声明修改时间字段
     ...
     **/
    public function GetListByPage($where=array(), $page=1, $limit=10, $order="spec_id")
    {   
        return $this->where($where)->page($page,$limit)->order($order)->select();
    }

    //获取数据列表，不分页
    public function GetDataList($where=array(), $order="spec_id")
    {
