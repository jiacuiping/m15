...
class WxPayConfig extends WxPayConfigInterface
{
	...
	**/
	...
	{
		return "http://new.m15.ltd/index/user/privilege";
	}
	...
	{
		return 'LfNuKo4VMI64iA8MJFrkGXYhfRggXBop';
	}
	...
	{
		$sslCertPath = ROOT_PATH . 'cert/apiclient_cert.pem';
		$sslKeyPath = ROOT_PATH . 'cert/apiclient_key.pem';
	}
}
